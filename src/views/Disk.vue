    ...
    <div class="table-main">
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template #default="scope">
                    <div style="display: flex; align-items: center">
                        <el-button v-if="scope.row.folder" @click="openFolder(scope.row.folderId)" type="text" size="small">
            ...
            <el-table-column
                    ...
                    width="120">
                <template #default='scope'>
                    <el-button v-if="scope.row.fileType===1" v-clipboard:copy="scope.row.filePath" v-clipboard:success="copySuccess(scope.row)" type="text" size="small">复制url</el-button>
                ...
                options: {
                    ...
                    query: function (file, res, status) {
                        ...
                        if (self.fileFolderId != null) {
                            param.fileFolderId = self.fileFolderId
                        }
                        return param;
                    },
